...
Encoders leftEncoder(A4,A5);	// Create an Encoder object name leftEncoder, using digitalpin 2 & 3
Encoders rightEncoder(A4,A5); // Encoder object name rightEncoder using analog pin A0 and A1 
