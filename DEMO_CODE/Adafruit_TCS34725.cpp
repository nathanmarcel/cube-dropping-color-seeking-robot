...
/**************************************************************************/
/*!
    @brief  Reads the red, green and blue values interpreted from gamma table
			and return the lux reading
*/
/**************************************************************************/
uint16_t Adafruit_TCS34725::getRGB (uint8_t *r, uint8_t *g, uint8_t *b) {
	 ...
	 *b = gammatable[map(blue, 0, clear, 0, 255)];
	 return calculateLux(red,green,blue);
}
